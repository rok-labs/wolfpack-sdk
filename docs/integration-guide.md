...
At **$0.50 per call**, `mega_report` runs all 5 services in parallel and returns a unified response — one call, one response, all dimensions of intelligence in one request.
