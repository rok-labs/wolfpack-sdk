...
async function main() {
  ...
  // Output: ['security_check', 'token_risk_analysis', 'narrative_momentum',
  //          'token_market_snapshot', 'smart_money_signals', 'technical_analysis',
  //          'mega_report', 'prediction_market', 'il_calculator', 'yield_scanner']
